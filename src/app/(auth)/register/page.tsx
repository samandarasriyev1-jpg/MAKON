                ...
                <form className="space-y-4" onSubmit={handleRegister}>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 rounded-xl bg-white/5 border border-white/10 py-3 font-medium text-white hover:bg-white/10 transition-all text-sm"
                        >
